        ...
        Select Case e.ColumnIndex
            ...
            Case 11
                ...
                If DialogResult.Yes = respuestaBorrar Then
                    ...
                    Dim row = dgListaPacientes.Rows(e.RowIndex)
                    Dim cells = row.Cells

                    Dim bandera = tmpNegocios.BorrarPaciente(id)
                    If bandera Then

                        Dim listaPac As List(Of Objetos.Paciente)
                        listaPac = tmpNegocios.ListaPacientes()

                        If listaPac.Count > 0 Then
                            Dim _tabla As New DataTable
                            _tabla.Columns.Add("Nombre")
                            _tabla.Columns.Add("Apellidos")
                            _tabla.Columns.Add("Identificación")
                            ...
                            _tabla.Columns.Add("FechaNacimiento")
                            _tabla.Columns.Add("Teléfono")
                            _tabla.Columns.Add("Correo")
                            _tabla.Columns.Add("EstáActivo")
                            _tabla.Columns.Add("Distrito")

                            For Each objP As Objetos.Paciente In listaPac
                                _tabla.Rows.Add(objP.Nombre, objP.Apellidos, objP.Identificacion, objP.TipoIdentificacion, objP.Sexo, objP.EstadoCivil, objP.Nacionalidad,
                                    objP.FechaNacimiento, objP.NumeroTelefonico, objP.Correo, objP.EstaActivo, objP.IdDistrito)
                            Next
                        ...
                        End If
                    Else
                        MessageBox.Show("Error al borrar el paciente", "Error", MessageBoxButtons.OK, MessageBoxIcon.Error)
                    End If
