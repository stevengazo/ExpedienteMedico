...
CREATE DATABASE [Proyecto_Hospital]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Proyecto_Hospital', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Proyecto_Hospital.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Proyecto_Hospital_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL15.SQLEXPRESS\MSSQL\DATA\Proyecto_Hospital_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
...
INSERT [dbo].[Diagnostico] ([idDiagnostico], [Fecha], [Descripcion], [Enfermedad_id]) VALUES (9, CAST(N'2022-12-22' AS Date), N'Prueba de ingreso', 2)
...
INSERT [dbo].[Enfermedades] ([idEnfermedad], [Nombre], [Descripcion], [Sintomas]) VALUES (2, N'Gripe', N'Virus respiratorio', N'Dolor de cabeza, fiebre y mucosa')
INSERT [dbo].[Enfermedades] ([idEnfermedad], [Nombre], [Descripcion], [Sintomas]) VALUES (3, N'Covid-19', N'Enfermedad infecciosa viral', N'Dolor de cabeza, fiebre. tos')
...
INSERT [dbo].[InventarioMedico] ([idInventario], [NumLote], [FechaIngreso], [FechaVencimiento], [Refrigeracion], [CantDisponible], [Medicamento_id]) VALUES (10, N'2ewd', CAST(N'2022-12-15' AS Date), CAST(N'2022-12-30' AS Date), 0, 2, 2)
...
INSERT [dbo].[Registro] ([idRegistro], [Medico_id], [Diagnostico_id], [Receta_id], [Cita_id], [Sucursal_id], [Expediente_id]) VALUES (5, 0, 0, 0, 13, 2, 1)
INSERT [dbo].[Registro] ([idRegistro], [Medico_id], [Diagnostico_id], [Receta_id], [Cita_id], [Sucursal_id], [Expediente_id]) VALUES (6, 0, 9, 0, 14, 1, 1)
...
INSERT [dbo].[Registro] ([idRegistro], [Medico_id], [Diagnostico_id], [Receta_id], [Cita_id], [Sucursal_id], [Expediente_id]) VALUES (8, 0, 0, 0, 0, 3, 1)
